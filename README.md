...
This library currently ships with Unicode 13.0.0 support. It has the ability to use Unicode 11.0.0
to Unicode 13.0.0. While this library likely supports versions of Unicode less than 11.0.0, the
format of the Unicode test files were changed beginning in 11.0.0 and as a result, versions of
Unicode less than 11.0.0 have not been tested.
